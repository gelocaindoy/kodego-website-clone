        ...
        <div id="nav">
                ...
                <div class="container"><a href="/" aria-current="page" class="navbar-brand nuxt-link-exact-active nuxt-link-active" target="_self">
                    <img src="https://dy9hpnbyn8tl0.cloudfront.net/kodego-large.svg" alt="KodeGo" class="logo"></a>
                                ...
                                <li class="nav-item"><a href="" class="nav-link" target="_self">Courses</a></li>
                                <li class="nav-item"><a href="" class="nav-link" target="_self">Partners</a></li>
                                <li class="nav-item"><a href="" class="nav-link" target="_self">Blog</a></li>
                                <li class="nav-item"><a href="" class="nav-link" target="_self">Careers</a></li>
                                <li class="nav-item"><a href="" class="nav-link" target="_self">FAQ</a></li>
                                <li class="nav-item auth-links"><a href="" class="btn fw-700 text-success px-4 py-0" role="button">Sign In</a>
